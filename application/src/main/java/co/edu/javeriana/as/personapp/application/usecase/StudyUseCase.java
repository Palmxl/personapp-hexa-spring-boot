...
public class StudyUseCase implements StudyInputPort {
	...
	public Study edit(Integer personId, Integer professionId, Study study) throws NoExistException {
		Study old = studyPersintence.findById(personId, professionId);
		if (old != null)
			return studyPersintence.save(study);
		throw new NoExistException("The study with personId " + personId + " and professionId " + professionId + " does not exist into db, cannot be edited");
	}
	...
	public Boolean drop(Integer personId, Integer professionId) throws NoExistException {
		...
		throw new NoExistException("The study with personId " + personId + " and professionId " + professionId + " does not exist into db, cannot be dropped");
	}
